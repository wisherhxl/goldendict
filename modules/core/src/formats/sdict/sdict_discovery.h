...
#ifndef GOLDENDICT_CORE_SRC_FORMATS_SDICT_SDICT_DISCOVERY_H_
#define GOLDENDICT_CORE_SRC_FORMATS_SDICT_SDICT_DISCOVERY_H_
...
#endif  // GOLDENDICT_CORE_SRC_FORMATS_SDICT_SDICT_DISCOVERY_H_
