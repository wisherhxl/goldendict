...
#ifndef GOLDENDICT_CORE_SRC_FORMATS_ZIM_ZIM_DICTIONARY_H_
#define GOLDENDICT_CORE_SRC_FORMATS_ZIM_ZIM_DICTIONARY_H_
...
class Dictionary final : public dictionary::Backend {
   public:
    static Dictionary Open(std::string id, const Files& files);
