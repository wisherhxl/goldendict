...
#ifndef GOLDENDICT_CORE_SRC_FORMATS_GLS_GLS_DICTIONARY_H_
#define GOLDENDICT_CORE_SRC_FORMATS_GLS_GLS_DICTIONARY_H_
...
#endif  // GOLDENDICT_CORE_SRC_FORMATS_GLS_GLS_DICTIONARY_H_
