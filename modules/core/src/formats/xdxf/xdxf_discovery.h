...
#ifndef GOLDENDICT_CORE_SRC_FORMATS_XDXF_XDXF_DISCOVERY_H_
#define GOLDENDICT_CORE_SRC_FORMATS_XDXF_XDXF_DISCOVERY_H_
...
#endif  // GOLDENDICT_CORE_SRC_FORMATS_XDXF_XDXF_DISCOVERY_H_
