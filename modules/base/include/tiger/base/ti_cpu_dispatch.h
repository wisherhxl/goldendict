// This file is part of Tiger project.
...
#define TI_CPU_OPTIMIZATION_NAMESPACE_BEGIN namespace __TI_CAT(opt_, TI_CPU_DISPATCH_MODE) {
...
#define __TI_CPU_DISPATCH(fn, args, mode, ...) __TI_EXPAND(__TI_CPU_DISPATCH_CHAIN_ ## mode(fn, args, __VA_ARGS__))
#define __TI_CPU_DISPATCH_EXPAND(fn, args, ...) __TI_EXPAND(__TI_CPU_DISPATCH(fn, args, __VA_ARGS__))
#define TI_CPU_DISPATCH(fn, args, ...) __TI_CPU_DISPATCH_EXPAND(fn, args, __VA_ARGS__, END) // expand macros


#if defined TI_ENABLE_INTRINSICS \
    && !defined TI_DISABLE_OPTIMIZATION \
...
#if defined _WIN32 && (defined(_M_ARM) || defined(_M_ARM64)) && (defined(TI_CPU_COMPILE_NEON) || !defined(_MSC_VER))
# include <Intrin.h>
# include <arm_neon.h>
# define TI_NEON 1
...
#define __TI_AVX_GUARD VZeroUpperGuard __vzeroupper_guard; TI_UNUSED(__vzeroupper_guard);
#endif
...
#  define TI_SSE 1
#  define TI_SSE2 1
#elif defined _WIN32 && (defined(_M_ARM) || defined(_M_ARM64)) && (defined(TI_CPU_COMPILE_NEON) || !defined(_MSC_VER))
# include <Intrin.h>
# include <arm_neon.h>
# define TI_NEON 1
#elif defined(__ARM_NEON__) || (defined (__ARM_NEON) && defined(__aarch64__))
