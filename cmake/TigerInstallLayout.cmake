...
elseif(WIN32 AND CMAKE_HOST_SYSTEM_NAME MATCHES Windows)
  ...
  if(DEFINED TIGER_RUNTIME AND DEFINED TIGER_ARCH)
    ti_update(TIGER_INSTALL_BINARIES_PREFIX "${TIGER_ARCH}/${TIGER_RUNTIME}/")
  else()
...
elseif(QNX)
  ...
  ti_update(TIGER_CONFIG_INSTALL_PATH      "${CPUVARDIR}/usr/share/${PROJECT_NAME}")
  ti_update(TIGER_INCLUDE_INSTALL_PATH     "usr/include/${PROJECT_NAME}/${TI_INTERNAL_NAME}")
  ti_update(TIGER_OTHER_INSTALL_PATH       "usr/share/${PROJECT_NAME}")
  ti_update(TIGER_SAMPLES_SRC_INSTALL_PATH "samples/native")
  ti_update(TIGER_LICENSES_INSTALL_PATH    "${TIGER_OTHER_INSTALL_PATH}/licenses")
  ti_update(TIGER_TEST_DATA_INSTALL_PATH   "${TIGER_OTHER_INSTALL_PATH}/testdata")
  ti_update(TIGER_DOC_INSTALL_PATH         "doc")
  ti_update(TIGER_JAR_INSTALL_PATH         "${CMAKE_INSTALL_DATAROOTDIR}/java/${TI_INTERNAL_NAME}")
  ...
  ti_update(TIGER_LIB_ARCHIVE_INSTALL_PATH   "${TIGER_LIB_INSTALL_PATH}")
  ti_update(TIGER_3P_LIB_INSTALL_PATH        "${TIGER_LIB_INSTALL_PATH}/${TI_INTERNAL_NAME}/3rdparty")
  ti_update(TIGER_CONFIG_INSTALL_PATH        "${TIGER_LIB_INSTALL_PATH}/cmake/${TI_INTERNAL_NAME}")
  ti_update(TIGER_INCLUDE_INSTALL_PATH       "${CMAKE_INSTALL_INCLUDEDIR}/${TI_INTERNAL_NAME}")
  ti_update(TIGER_OTHER_INSTALL_PATH         "${CMAKE_INSTALL_DATAROOTDIR}/${TI_INTERNAL_NAME}")
  ti_update(TIGER_SAMPLES_SRC_INSTALL_PATH   "${TIGER_OTHER_INSTALL_PATH}/samples")
  ti_update(TIGER_LICENSES_INSTALL_PATH      "${CMAKE_INSTALL_DATAROOTDIR}/licenses/${TI_INTERNAL_NAME}")
  ti_update(TIGER_TEST_DATA_INSTALL_PATH     "${TIGER_OTHER_INSTALL_PATH}/testdata")
  ti_update(TIGER_DOC_INSTALL_PATH           "${CMAKE_INSTALL_DATAROOTDIR}/doc/${TI_INTERNAL_NAME}")
  ti_update(TIGER_JAR_INSTALL_PATH           "${CMAKE_INSTALL_DATAROOTDIR}/java/${TI_INTERNAL_NAME}")
  ti_update(TIGER_JNI_INSTALL_PATH           "${TIGER_JAR_INSTALL_PATH}")
  ti_update(TIGER_JNI_BIN_INSTALL_PATH       "${TIGER_JNI_INSTALL_PATH}")
