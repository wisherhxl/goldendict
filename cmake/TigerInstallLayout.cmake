...
elseif(WIN32 AND CMAKE_HOST_SYSTEM_NAME MATCHES Windows)
  ...
  ti_update(TIGER_LIB_ARCHIVE_INSTALL_PATH   "${TIGER_LIB_INSTALL_PATH}")
  ti_update(TIGER_3P_LIB_INSTALL_PATH        "${TIGER_LIB_INSTALL_PATH}/tiger4/3rdparty")
  ti_update(TIGER_CONFIG_INSTALL_PATH        "${TIGER_LIB_INSTALL_PATH}/cmake/tiger4")
  ti_update(TIGER_INCLUDE_INSTALL_PATH       "${CMAKE_INSTALL_INCLUDEDIR}/tiger4")
  ti_update(TIGER_OTHER_INSTALL_PATH         "${CMAKE_INSTALL_DATAROOTDIR}/tiger4")
  ti_update(TIGER_SAMPLES_SRC_INSTALL_PATH   "${TIGER_OTHER_INSTALL_PATH}/samples")
  ti_update(TIGER_LICENSES_INSTALL_PATH      "${CMAKE_INSTALL_DATAROOTDIR}/licenses/tiger4")
  ti_update(TIGER_TEST_DATA_INSTALL_PATH     "${TIGER_OTHER_INSTALL_PATH}/testdata")
  ti_update(TIGER_DOC_INSTALL_PATH           "${CMAKE_INSTALL_DATAROOTDIR}/doc/tiger4")
