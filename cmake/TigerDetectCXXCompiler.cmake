...
if(TIGER_SKIP_SYSTEM_PROCESSOR_DETECTION)
...
if(NOT DEFINED TIGER_STATIC)
  ...
  if(NOT DEFINED BUILD_SHARED_LIBS OR BUILD_SHARED_LIBS)
    set(TIGER_STATIC OFF)
  else()
    set(TIGER_STATIC ON)
  endif()
endif()

if(DEFINED TIGER_ARCH AND DEFINED TIGER_RUNTIME)
...
elseif(MSVC)
  ...
  if(MSVC_VERSION EQUAL 1400)
    set(TIGER_RUNTIME vc8)
  elseif(MSVC_VERSION EQUAL 1500)
    set(TIGER_RUNTIME vc9)
  elseif(MSVC_VERSION EQUAL 1600)
    set(TIGER_RUNTIME vc10)
  elseif(MSVC_VERSION EQUAL 1700)
    set(TIGER_RUNTIME vc11)
  elseif(MSVC_VERSION EQUAL 1800)
    set(TIGER_RUNTIME vc12)
  elseif(MSVC_VERSION EQUAL 1900)
    set(TIGER_RUNTIME vc14)
  elseif(MSVC_VERSION MATCHES "^191[0-9]$")
    set(TIGER_RUNTIME vc15)
  elseif(MSVC_VERSION MATCHES "^192[0-9]$")
    set(TIGER_RUNTIME vc16)
...
if(HAVE_CXX11 AND (X86 OR X86_64))
  set(__TIGER_ENABLE_ATOMIC_LONG_LONG ON)
endif()
option(TIGER_ENABLE_ATOMIC_LONG_LONG "Enable C++ compiler support for atomic<long long>" ${__TIGER_ENABLE_ATOMIC_LONG_LONG})

if((HAVE_CXX11 AND TIGER_ENABLE_ATOMIC_LONG_LONG
        AND NOT MSVC
        AND NOT (X86 OR X86_64)
    AND NOT TIGER_SKIP_LIBATOMIC_COMPILER_CHECK)
    OR TIGER_FORCE_LIBATOMIC_COMPILER_CHECK
)
  ti_check_compiler_flag(CXX "" HAVE_CXX_ATOMICS_WITHOUT_LIB "${TIGER_SOURCE_DIR}/cmake/checks/atomic_check.cpp")
  if(NOT HAVE_CXX_ATOMICS_WITHOUT_LIB)
    list(APPEND CMAKE_REQUIRED_LIBRARIES atomic)
    ti_check_compiler_flag(CXX "" HAVE_CXX_ATOMICS_WITH_LIB "${TIGER_SOURCE_DIR}/cmake/checks/atomic_check.cpp")
    if(HAVE_CXX_ATOMICS_WITH_LIB)
      set(HAVE_ATOMIC_LONG_LONG ON)
      list(APPEND TIGER_LINKER_LIBS atomic)
    else()
...
else(HAVE_CXX11 AND TIGER_ENABLE_ATOMIC_LONG_LONG)
  set(HAVE_ATOMIC_LONG_LONG ${TIGER_ENABLE_ATOMIC_LONG_LONG})
endif()
