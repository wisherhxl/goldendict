    ...
    FOREACH(src ${_sources})
      if(NOT "${src}" MATCHES "\\.mm$" AND NOT "${src}" MATCHES "\\.rc$")
        ...
        if(NOT _flags AND NOT _flags2)
          ...
          #ti_debug_message("Skip PCH, flags: ${oldProps} defines: ${oldProps2}, file: ${src}")
        endif()
      endif()
    ENDFOREACH()
...
MACRO(ADD_PRECOMPILED_HEADER _targetName _input)
    ...
    if(type STREQUAL "SHARED_LIBRARY" OR type STREQUAL "STATIC_LIBRARY")
      ...
      if(__pic AND CMAKE_CXX_COMPILE_OPTIONS_PIC
          AND NOT TIGER_SKIP_PCH_PIC_HANDLING
          AND NOT TIGER_SKIP_PCH_PIC_HANDLING_${_targetName}
      )
    ...
    elseif(type STREQUAL "EXECUTABLE")
      ...
      if(__pie AND CMAKE_CXX_COMPILE_OPTIONS_PIE
          AND NOT TIGER_SKIP_PCH_PIE_HANDLING
          AND NOT TIGER_SKIP_PCH_PIE_HANDLING_${_targetName}
      )
