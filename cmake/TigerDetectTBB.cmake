...
#   - "tbb" target exists and added to TIGER_LINKER_LIBS

function(ti_tbb_cmake_guess _found)
    ...
    if(TBB_FOUND)
      ...
      ti_tbb_read_version("${_inc}" tbb)
      set(${_found} TRUE PARENT_SCOPE)
    endif()
endfunction()

function(ti_tbb_env_verify)
...
function(ti_tbb_env_guess _found)
  ...
  if (TBB_ENV_INCLUDE AND (TBB_ENV_LIB OR TBB_ENV_LIB_DEBUG))
    ...
    ti_tbb_read_version("${TBB_ENV_INCLUDE}" tbb)
...
function(ti_tbb_read_version _path _tgt)
  ...
  ti_parse_header("${TBB_VER_FILE}" TBB_VERSION_LINES TBB_VERSION_MAJOR TBB_VERSION_MINOR TBB_INTERFACE_VERSION CACHE)
endfunction()
...
if(NOT HAVE_TBB)
  ti_tbb_cmake_guess(HAVE_TBB)
endif()

if(NOT HAVE_TBB)
  ti_tbb_env_guess(HAVE_TBB)
endif()
