...
set(BUILD_LIST "" CACHE STRING "Build only listed modules (comma-separated, e.g. 'base,sim,opt,...')")
set(BUILD_APP_LIST "" CACHE STRING "Build only listed applications (comma-separated, e.g. 'example,tester,...')")
...
TI_OPTION(TIGER_CMAKE_DEBUG_MESSAGES "Enable debug messages for Tiger CMake scripts" OFF)
...
# ----------------------------------------------------------------------------
ti_update(TIGER_CONFIG_FILE_INCLUDE_DIR "${CMAKE_BINARY_DIR}/" CACHE PATH "Where to create the platform-dependant ti_config.h")
