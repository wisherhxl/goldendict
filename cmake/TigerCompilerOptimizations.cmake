...
if(X86 OR X86_64)
  ...
  ti_update(CPU_SSE_TEST_FILE "${Tiger_SOURCE_DIR}/cmake/checks/cpu_sse.cpp")
  ti_update(CPU_SSE2_TEST_FILE "${Tiger_SOURCE_DIR}/cmake/checks/cpu_sse2.cpp")
  ti_update(CPU_SSE3_TEST_FILE "${Tiger_SOURCE_DIR}/cmake/checks/cpu_sse3.cpp")
  ti_update(CPU_SSSE3_TEST_FILE "${Tiger_SOURCE_DIR}/cmake/checks/cpu_ssse3.cpp")
  ti_update(CPU_SSE4_1_TEST_FILE "${Tiger_SOURCE_DIR}/cmake/checks/cpu_sse41.cpp")
  ti_update(CPU_SSE4_2_TEST_FILE "${Tiger_SOURCE_DIR}/cmake/checks/cpu_sse42.cpp")
  ti_update(CPU_POPCNT_TEST_FILE "${Tiger_SOURCE_DIR}/cmake/checks/cpu_popcnt.cpp")
  ti_update(CPU_AVX_TEST_FILE "${Tiger_SOURCE_DIR}/cmake/checks/cpu_avx.cpp")
  ti_update(CPU_AVX2_TEST_FILE "${Tiger_SOURCE_DIR}/cmake/checks/cpu_avx2.cpp")
  ti_update(CPU_FP16_TEST_FILE "${Tiger_SOURCE_DIR}/cmake/checks/cpu_fp16.cpp")
  ti_update(CPU_AVX_512F_TEST_FILE "${Tiger_SOURCE_DIR}/cmake/checks/cpu_avx512.cpp")
  ti_update(CPU_AVX512_COMMON_TEST_FILE "${Tiger_SOURCE_DIR}/cmake/checks/cpu_avx512common.cpp")
  ti_update(CPU_AVX512_KNL_TEST_FILE "${Tiger_SOURCE_DIR}/cmake/checks/cpu_avx512knl.cpp")
  ti_update(CPU_AVX512_KNM_TEST_FILE "${Tiger_SOURCE_DIR}/cmake/checks/cpu_avx512knm.cpp")
  ti_update(CPU_AVX512_SKX_TEST_FILE "${Tiger_SOURCE_DIR}/cmake/checks/cpu_avx512skx.cpp")
  ti_update(CPU_AVX512_CNL_TEST_FILE "${Tiger_SOURCE_DIR}/cmake/checks/cpu_avx512cnl.cpp")
  ti_update(CPU_AVX512_CLX_TEST_FILE "${Tiger_SOURCE_DIR}/cmake/checks/cpu_avx512clx.cpp")
  ti_update(CPU_AVX512_ICL_TEST_FILE "${Tiger_SOURCE_DIR}/cmake/checks/cpu_avx512icl.cpp")
