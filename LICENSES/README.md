...
- The application translation source inventory under `apps/goldendict/lang/`
  is derived from pinned legacy GoldenDict revision `3d93dd66` and remains
  GPL-3.0-or-later. Only the explicitly enabled catalog is compiled or shipped.
