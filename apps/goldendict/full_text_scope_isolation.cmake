...
function(gd_check_full_text_scope_isolation root_target)
  ...
  while(pending)
    ...
    if(current MATCHES "^(full_text_dictionary_scope_test|dictionary_bar_test|view_menu_test|view_menu_test_access|articles_preferences_test|articles_preferences_test_access)$")
    ...
    foreach(property SOURCES INTERFACE_SOURCES LINK_LIBRARIES INTERFACE_LINK_LIBRARIES MANUALLY_ADDED_DEPENDENCIES)
      ...
      foreach(value IN LISTS values)
        if(value MATCHES "full_text_dictionary_scope_(test|test_access)\\.(cpp|cc|h)" OR
           value MATCHES "(full_text_dictionary_scope_test|dictionary_bar_test|view_menu_test|view_menu_test_access|articles_preferences_test|articles_preferences_test_access|dictionary_scope_test_access)")
