...
| Dictionary identity and index lifecycle | slice | Phase 4 | deterministic index tests plus paired changed-source, unavailable-companion, stale-index cleanup, and recovery evidence with matching observer-visible diagnostics |
