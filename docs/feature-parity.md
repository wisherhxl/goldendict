...
| Preferences and source editor | slice | Phase 8 | core-owned bounded defaults, validation, atomic round-trip, older-current compatibility, portable legacy migration, and runtime wiring for exact tab-opening preferences; source editing, credentials, and preferences UI remain |
