...
| Preferences and source editor | slice | Phase 8 | core-owned bounded current preference defaults, validation, deterministic atomic round-trip, and older-current-format compatibility; legacy preference migration, source editing, Widgets UI, and behavior wiring remain |
