...
| Help | slice | Phase 9 | pinned legacy English and Russian Qt help collections are installed and privately presented on Linux with bounded legacy locale selection; full-text Help routes privately to the installed `Full-text search` identifier; settings UI and persistence remain mapped |
