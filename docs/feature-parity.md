...
| Morphology and transliteration | later | Phase 5 | the private bounded Russian, German, Greek, and three-variant Belarusian table primitives preserve pinned longest-match and unmatched-Unicode behavior with data-driven tests; Russian, German, and Greek retain case-sensitive mappings, while Belarusian retains simple case folding, first-wins duplicates, and exact 334/333, 535/534, and 446/436 declaration/effective counts; German also preserves disabled reverse mappings and Greek covers modern/classical Beta Code, alternate diacritic order, and tonos/oxia conversion; dictionary-provider composition, configuration, morphology, Romaji, and Chinese conversion remain later leaves |
