...
| Full-text search | slice | Phase 5/6/8 | installed bounded query and private reference-index contract complete; P6-FT-1 StarDict, P6-FT-2 SDict, P6-FT-3 XDXF, and P6-FT-4 Dictd adapters are accepted; the next adapter requires a fresh independent readiness audit before the Phase 8 workflow |
