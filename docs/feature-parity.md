...
| Dictionary info/headword browser | slice | Phase 8 | facade-backed catalog identity/source display, bounded per-dictionary prefix suggestions, lookup activation, atomic displayed-headword export, and fixture-backed UI smokes; counts, descriptions, unbounded full-list export, advanced filtering, and local-file actions remain |
