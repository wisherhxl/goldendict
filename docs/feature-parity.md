...
| Help | slice | Phase 9 | pinned legacy English and Russian Qt help collections are installed and privately presented on Linux with bounded legacy locale selection; full-text Help and dictionary-browser Help/F1 route privately through the single presenter to their installed identifiers; Preferences and Manage Dictionaries help ownership, settings UI, and persistence remain mapped |
