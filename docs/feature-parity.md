...
| Full-text search | slice | Phase 5/6/8 | installed bounded query and private reference-index contract complete; P6-FT-1 StarDict, P6-FT-2 SDict, P6-FT-3 XDXF, P6-FT-4 Dictd, P6-FT-5 GLS, and P6-FT-6 Aard adapters are accepted; no later leaf is selected |
