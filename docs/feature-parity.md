...
| Morphology and transliteration | later | Phase 5 | the private bounded Russian table primitive preserves pinned longest-match, case-sensitive, and unmatched-Unicode behavior with data-driven tests; dictionary-provider composition, configuration, morphology, and other transliterations remain later per-language leaves |
